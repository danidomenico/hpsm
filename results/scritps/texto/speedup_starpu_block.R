...
dados <- dados[( ((dados$BENCH == "hotspot") & (dados$size == 16384)) | 
                 ...
                 ((dados$BENCH == "cfd")     & (dados$size == 131072) & (dados$block_size != 8192)) ) & 
               ( (dados$backend == "PARALLEL_BACK_STARPU") | 
                 (dados$backend == "PARALLEL_BACK_STARPU_OPENMP") | 
                 (dados$backend == "PARALLEL_BACK_STARPU_KAAPI") ),]
...
dados$backend <- ifelse(dados$backend == "PARALLEL_BACK_STARPU" & 
                        ( (dados$BENCH == "hotspot" & dados$block_size == 1024) |
                          ...
                          (dados$BENCH == "cfd"     & dados$block_size == 2048) ), "StarPU  ", as.character(dados$backend))
dados$backend <- ifelse(dados$backend == "PARALLEL_BACK_STARPU" & 
                        ( (dados$BENCH == "hotspot" & dados$block_size == 2048) |
                          (dados$BENCH == "nbody"   & dados$block_size == 4096) |
                          (dados$BENCH == "cfd"     & dados$block_size == 4096) ), "StarPU(dobro)  ", as.character(dados$backend))
dados$backend <- ifelse(dados$backend == "PARALLEL_BACK_STARPU_OPENMP" &
                        ( (dados$BENCH == "hotspot" & dados$block_size == 1024) |
                          (dados$BENCH == "nbody"   & dados$block_size == 2048) |
                          (dados$BENCH == "cfd"     & dados$block_size == 2048) ), "StarPU+OMP  ", as.character(dados$backend))
dados$backend <- ifelse(dados$backend == "PARALLEL_BACK_STARPU_OPENMP" & 
                        ( (dados$BENCH == "hotspot" & dados$block_size == 2048) |
                          (dados$BENCH == "nbody"   & dados$block_size == 4096) |
                          (dados$BENCH == "cfd"     & dados$block_size == 4096) ), "StarPU+OMP(dobro)  ", as.character(dados$backend))
dados$backend <- ifelse(dados$backend == "PARALLEL_BACK_STARPU_KAAPI" &
                        ( (dados$BENCH == "hotspot" & dados$block_size == 1024) |
                          (dados$BENCH == "nbody"   & dados$block_size == 2048) |
                          (dados$BENCH == "cfd"     & dados$block_size == 2048) ), "StarPU+Kaapi  ", as.character(dados$backend))
dados$backend <- ifelse(dados$backend == "PARALLEL_BACK_STARPU_KAAPI" & 
                        ( (dados$BENCH == "hotspot" & dados$block_size == 2048) |
                          (dados$BENCH == "nbody"   & dados$block_size == 4096) |
                          (dados$BENCH == "cfd"     & dados$block_size == 4096) ), "StarPU+Kaapi(dobro)  ", as.character(dados$backend))
